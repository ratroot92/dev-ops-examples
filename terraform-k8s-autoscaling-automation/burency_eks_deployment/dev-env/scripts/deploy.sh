...
# kubectl delete -k /home/asd/Desktop/vaultspay/eks/dev/k8s/misc/
# kubectl delete -k /home/asd/Desktop/vaultspay/eks/dev/k8s/zookeeper/
# kubectl delete -k /home/asd/Desktop/vaultspay/eks/dev/k8s/kafka/
...
kubectl apply -f /home/asd/Desktop/vaultspay/eks/dev/k8s/misc/cluster-autoscaler.yml
...
sleep 15
kubectl apply -k /home/asd/Desktop/vaultspay/eks/dev/k8s/misc/
kubectl apply -k /home/asd/Desktop/vaultspay/eks/dev/k8s/zookeeper/
## Required for kafka to work  (/home/asd/Desktop/vaultspay/eks/dev/k8s/kafka/debug.txt)
kubectl create clusterrolebinding fixRBACKafka --clusterrole=cluster-admin --serviceaccount=default:default
kubectl apply -k /home/asd/Desktop/vaultspay/eks/dev/k8s/kafka/
...
kubectl apply -f /home/asd/Desktop/vaultspay/eks/dev/k8s/misc/redis-commander.yml
